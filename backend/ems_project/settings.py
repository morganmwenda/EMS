...
SECRET_KEY = 'django-insecure-emergency-management-system-key-change-in-production'
...
# TODO: Enable GIS support later with proper spatial database setup
# For GIS support, change to:
# DATABASES = {
#     'default': {
...
AMBULANCE_SEARCH_RADIUS = 50  # kilometers
DEFAULT_AMBULANCE_SPEED = 60  # km/h for ETA calculation